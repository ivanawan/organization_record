                        ...
                        <div class="row ">
                            ...
                            <div class="col">
                                @if (session('group')['role'] == 1 or session('group')['role'] == 2)
                                    <div class="dropdown">
                                        <div style="float: right">
                                            <a href="{{ url('/group/delete/anggota' . $item->id) }}" class="btn"
                                                        ...
                                                        <li>
                                                            <div class="form-check">
                                                                <input class="form-check-input" value="1" type="radio"
                                                                    name="role" id="flexRadioDefault1" checked>
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" value="2" type="radio"
                                                                name="role" id="flexRadioDefault1">
                                                            <label class="form-check-label" for="flexRadioDefault1">
                                                                wakil ketua
                                                            </label>
                                                        </div>
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="role"
                                                                value="2" id="flexRadioDefault1" checked>
                                                            <label class="form-check-label" for="flexRadioDefault1">
                                                                wakil ketua
                                                            </label>
                                                        </div>
                                ...
                                @if (session('group')['role'] == 1 or session('group')['role'] == 2)
                                    <div class="dropdown">
                                        <div style="float: right">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                <form action="{{ url('/group/changerole/' . $item->id_user) }}"
                                                    method="POST">
                                                    @csrf
                                                    @if (session('group')['role'] == 1)
                                                        <li>
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="role"
                                                                value="3" id="flexRadioDefault1" checked="checked">
                                                            <label class="form-check-label" for="flexRadioDefault1">
                                                                sekertaris
                                                            </label>
                                                        </div>
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                <form action="{{ url('/group/changerole/' . $item->id_user) }}"
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="role"
                                                                value="4" id="flexRadioDefault1" checked>
                                                            <label class="form-check-label" for="flexRadioDefault1">
                                                                bendahara
                                                            </label>
                                                        </div>
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                <form action="{{ url('/group/changerole/' . $item->id_user) }}"
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="radio" name="role"
                                                                value="5" id="flexRadioDefault1" checked>
                                                            <label class="form-check-label" for="flexRadioDefault1">
                                                                anggota
                                                            </label>
                                                        </div>
