                ...
                <div class="card">
                    <div class="card-header">
                        <button type="button" style="float: right"
                            class="btn btn-outline-primary">{{ $check . '/' . $all }}</button>
                        Absensi peserta
                    </div>
                                ...
                                <div class="col-1">
                                    <div class="form-check">
                                        @if (in_array($item->id, $checked))
                                            <input style="margin-top:4vh" class="form-check-input" type="checkbox"
                                                name="{{ 'checkbox' . $i++ }}" value="{{ $item->id }}"
                    ...
                    <div class="card-body" style="height: 60vh; overflow: auto;">
                        @foreach ($list as $item)
                            <div class="row">
                                ...
                                <div class="col-1">
                                    <div class="form-check">
                                        <input style="margin-top:4vh" class="form-check-input" type="radio" name="radio"
