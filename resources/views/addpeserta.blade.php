...
@section('content')
            ...
            <div class="container" style="padding-left:20%;padding-right:20%">
              ...
              <form method="POST"  action="{{url('/group/edit/peserta/'.$kelompok[0]->id)}}">                  
                ...
                <div class="mb-3">
                  <label for="exampleFormControlInput1" class="form-label">Nama Kelompok</label>
                  <input type="text"  class="form-control" name="name" value="{{$kelompok[0]->name_k}}" id="exampleFormControlInput1" placeholder="nama kelompok">
                </div>
                @php
                    $i=1;
                @endphp
                ...
                <div class="mb-3">
                  <input type="text" name="{{$item->id}}" value="{{$item->name}}" class="form-control" id="exampleFormControlInput1" placeholder="nama peserta 1">
                </div>                 
                @endforeach
                <div id="form"></div>
                <button type="button" onclick="add()" class="btn btn-outline-primary" style="border-style: dotted;width:48%">Tambah Baris</button>
